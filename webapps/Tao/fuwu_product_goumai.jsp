...
#table {
	...
	<body>
			...
			<div>
				<div id="background">
					<div id="templatemo_search">
						<form action="fuwu_product_goumai_deal.jsp" method="get">
		...
		<div>
			...
			<form name="form1"
				action="fuwu_product_goumai_deal.jsp?id=<%=fuwu_xiangxi.check_fuwu_rs.getString("proc_id")%>&seller=<%=fuwu_xiangxi.check_fuwu_rs.getString("seller_name")%>"
				method="post">
