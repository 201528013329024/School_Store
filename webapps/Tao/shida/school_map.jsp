			...
			<div>
				<div>
					<div>
						<div>
							<div id="article">
							<center><h2>赭山校区校区平面布局图</h2></center>
							<img src="map1.jpg" alt="Logo"><br/><br/><br/>
							<center><h2>花津校区功能布局图</h2></center>
							<img src="map2.jpg" alt="Logo"><br/><br/><br/>
							<center><h2>皖江学院校区平面图</h2></center>
							<img src="map3.jpg" alt="Logo">
							</div>
