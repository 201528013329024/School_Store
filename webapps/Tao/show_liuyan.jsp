...
<jsp:useBean id="show_liuyan" class="com.sql.link_SqlServer"
				...
				<div>
					...
					<ul>
						...
						<h2><a href="drop_proc.jsp">宝贝下架</a></h2>
							...
							<div style="margin-left: 204px; margin-top: -415px; width: 400px">
							...
							<div style="margin-left: 200px; margin-top: -415px; width: 740px;height: 440px">
								<table width="" border="0" align="left">
									...
									<%=show_liuyan.rs.getString("liuyan_id")%>
								</td>

										<td align="center">
											<%=show_liuyan.rs.getString("liuyan_person")%>
										</td>

										<td width="" align="center"><%=show_liuyan.rs.getString("give_price")%>
										</td>

										

										<td width="" align="center">
											<%=show_liuyan.rs.getString("liuyan_tel")%>
										</td>

										<td width="" align="center">
											<a
												href="show_liuyan_content.jsp?liuyan_id=<%=show_liuyan.rs.getString("liuyan_id")%>&proc_id=<%=show_liuyan.rs.getString("proc_id")%>&proc_type=<%=show_liuyan.rs.getString("proc_type")%>">回复留言</a>
										</td>

										<td width="" align="center">
											<%=show_liuyan.rs.getString("liuyan_time")%>
										</td>
								...
								<font color="#6666FF" size="+1"> 当前页数:【<%=showpage%>】&nbsp;&nbsp;&nbsp;
									...
									<a href="show_liuyan.jsp?page=1">第一页</a>&nbsp;&nbsp; <a
									href="show_liuyan.jsp?page=<%=showpage - 1%>">上一页</a>&nbsp;&nbsp;

									<a href="show_liuyan.jsp?page=<%=showpage + 1%>">下一页</a>
									&nbsp;&nbsp; <a href="show_liuyan.jsp?page=<%=pagecount%>">最后一页&nbsp;</a>&nbsp;&nbsp;
