...
<head>
	<meta charset="UTF-8">
	<title>服务 - 校园二手交易平台</title>
	<link rel="stylesheet" type="text/css" href="css/goodsstyle.css">
</head>
<jsp:useBean id="show_fuwu" class="com.sql.link_SqlServer" scope="session"></jsp:useBean>
	...
	<div id="body">
		<div>
			<div>
				<div>
					<div>
                   	 ...
                   	 //show_fuwu.rs.next(); 
                        	show_fuwu.rs.last();
							rowcount = show_fuwu.rs.getRow();//20
							...
							String top = request.getParameter("page");  //1
							...
							if (top != null) {
								showpage = ((Integer.parseInt(top))/16)+1;  //1   //1
							...
							show_fuwu.rs.absolute((showpage - 1) * 16 + 1);
							//show_fuwu.rs.next();
							
							
							//while (show_liuyan.rs.next()) {

							for (int i = 1; i <= pagesize; i++) {   //1 --  4
                 	 ...
                 	 %>
                        ...
                        <%if(show_fuwu.rs!= null) {%>
                        	<div style="margin-left:40px;">
                            	<div class="product_pic" align="center">
                                	<a target="_blank" href="fuwu_product.jsp?id=<%=show_fuwu.rs.getString("proc_id") %>"><img style="width:200px;height:200px" src="<%=show_fuwu.rs.getString("proc_pic_url")%>" alt="Image"" alt="Image"></a>
                                </div>
                                <div class="product_summ">
                                	<p align="center"><%=show_fuwu.rs.getString("proc_jianjie")%></p>
                                </div>
                                <div class="product_price">
                                	<p align="center">¥<%=show_fuwu.rs.getString("proc_price") %>元</p>
                                </div>
                        	</div>         	
                        	<% }%>
                        	
                        	
                        	<%if(show_fuwu.rs.next())  {%>
                        	<div style="margin-left:40px;">
                            	<div class="product_pic" align="center">
                                	<a target="_blank" href="fuwu_product.jsp?id=<%=show_fuwu.rs.getString("proc_id") %>"><img style="width:200px;height:200px" src="<%=show_fuwu.rs.getString("proc_pic_url")%>"></a>
                                </div>
                                <div class="product_summ">
                                	<p align="center"><%=show_fuwu.rs.getString("proc_jianjie")%></p>
                                </div>
                        	...
                        	<div style="margin-left:40px;">
                            	<div class="product_pic" align="center">
                                	<a target="_blank" href="fuwu_product.jsp?id=<%=show_fuwu.rs.getString("proc_id") %>"><img style="width:200px;height:200px" src="<%=show_fuwu.rs.getString("proc_pic_url")%>" alt="Image"></a>
                                </div>
                                <div class="product_summ">
                                	<p align="center"><%=show_fuwu.rs.getString("proc_jianjie")%></p>
                                </div>
			...
			<font color="#6666FF" size="+1"> 当前页数:【<%=showpage%>】&nbsp;&nbsp;&nbsp;
				...
				<a href="fuwu.jsp?page=1">第一页</a>&nbsp;&nbsp; <a
				href="fuwu.jsp?page=<%=showpage-16%>">上一页</a>&nbsp;&nbsp;

				<a href="fuwu.jsp?page=<%=showpage+16%>">下一页</a>
				&nbsp;&nbsp; <a href="fuwu.jsp?page=<%=pagecount%>">最后一页&nbsp;</a>&nbsp;&nbsp;
		</center>
