...
<jsp:useBean id="zz_tuijian" class="com.sql.link_SqlServer" scope="session"></jsp:useBean>
...
<% 
	...
	out.print("今天是"+year+"年"+month+"月"+day +"日"+" "+week+" ");
		...
		<li class="mysell current"><a href="zz_tuijian.jsp"><span>站长推荐</span></a></li>
	...
	<div id="body">
		<div>
                        ...
                        %>
                        	<div style="margin-left:40px;">
                            	<div class="product_pic" align="center">
                                	<a target="_blank" href=<%=url%>><img style="width:200px;height:200px" src="<%=zz_tuijian.show_gouwuche_content_rs.getString("proc_pic_url")%>" alt="Image"></a>
                                </div>
                                <div class="product_summ">
                                	<p align="center"><%=zz_tuijian.show_gouwuche_content_rs.getString("proc_jianjie")%></p>
                                </div>
                                <div class="product_price">
                                	<p align="center">¥<%=zz_tuijian.show_gouwuche_content_rs.getString("proc_price") %>元</p>
                                </div>
                        	</div>         	
                        	<% }%>
                            ...
                            %>
                            	<div style="margin-left:40px;">
                                	<div class="product_pic" align="center">
                                    	<a target="_blank" href=<%=url%>"><img style="width:200px;height:200px" src="<%=zz_tuijian.show_gouwuche_content_rs.getString("proc_pic_url")%>" alt="Image"></a>                                    </div>
                                    <div class="product_summ">
                                    	<p align="center"><%=zz_tuijian.show_gouwuche_content_rs.getString("proc_jianjie")%></p>
                                    </div>
                                    <div class="product_price">
			...
			<font color="#6666FF" size="+1"> 当前页数:【<%=showpage%>】&nbsp;&nbsp;&nbsp;
				...
				<a href="zz_tuijian.jsp?page=1">第一页</a>&nbsp;&nbsp; <a
				href="zz_tuijian.jsp?page=<%=showpage- 16%>">上一页</a>&nbsp;&nbsp;

				<a href="zz_tuijian.jsp?page=<%=showpage + 16%>">下一页</a>
				&nbsp;&nbsp; <a href="zz_tuijian.jsp?page=<%=pagecount%>">最后一页&nbsp;</a>&nbsp;&nbsp;
