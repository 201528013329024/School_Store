...
<jsp:useBean id="show_msg_content" class="com.sql.link_SqlServer"
				...
				<div>
					<div>
						...
						<ul>
							...
							<li>
								<h2><a href="show_msg.jsp">我的留言</a></h2>
							</li>
							<li>
...
<form name="form1"
				action="show_msg_content_deal.jsp?from_msg_id=<%=show_msg_content.rs.getString("huifu_liuyan_id")%>&proc_type=<%=show_msg_content.rs.getString("proc_type")%>&to_who=<%=show_msg_content.rs.getString("liuyan_person")%>&msg_person=<%=show_msg_content.rs.getString("to_who")%>"
				method="post">
							<div style="margin-left: 220px; margin-top: -440px; height:400px;width: 800px">
								<table width="" border="0" align="left">
									...
									<tr style="background-color: #3CF">
										...
										<td align="center">
											<%=show_msg_content.rs.getString("liuyan_person")%>
										</td>
									</tr>
									...
									<tr style="background-color: #3CF">
										...
										<td width="125" align="center">
											<textarea readonly rows="6" cols="40" ><%=show_msg_content.rs.getString("content")%></textarea>
										</td>
									</tr>
							...
							<div style="margin-left: 650px; margin-top: -415px; height:400px;width: 600px">
								<table width="" border="0" align="left">
									...
									<tr>
										<td>
											商品名称：<%=show_msg_content.check_proc_rs.getString("proc_name")%>
										</td>
									</tr>
									...
									<tr>
										<td>
											标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价：<%=show_msg_content.check_proc_rs.getString("proc_price")%>
										</td>
									</tr>
