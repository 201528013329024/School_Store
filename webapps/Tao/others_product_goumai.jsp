...
#table {
	...
	<body>
			...
			<div>
				<div id="background">
					<div id="templatemo_search">
						<form action="others_product_goumai_deal.jsp" method="get">
		...
		<div>
			...
			<form name="form1"
				action="others_product_goumai_deal.jsp?id=<%=others_xiangxi.check_others_rs.getString("proc_id")%>&seller=<%=others_xiangxi.check_others_rs.getString("seller_name")%>"
				method="post">
