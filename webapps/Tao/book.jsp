...
<jsp:useBean id="show_book" class="com.sql.link_SqlServer" scope="session"></jsp:useBean>
	...
	<div id="body">
		<div>
			<div>
				<div>
					<div>
                   	 ...
                   	 //show_book.rs.next(); 
                        	show_book.rs.last();
							rowcount = show_book.rs.getRow();//20
							...
							show_book.rs.absolute((showpage - 1) * 16 + 1);
							//show_book.rs.next();
                 	 ...
                 	 %>
                        ...
                        <%if(show_book.rs!= null) {%>
                        	<div style="margin-left:40px;">
                            	<div class="product_pic" align="center">
                                	<a target="_blank" href="book_product.jsp?id=<%=show_book.rs.getString("proc_id") %>"><img src="<%=show_book.rs.getString("proc_pic_url")%>" style="width:200px;height:200px"></a>               
                                </div>
                                <div class="product_summ">
                                	<p align="center"><%=show_book.rs.getString("proc_jianjie")%></p>
                                </div>
                                <div class="product_price">
                                	<p align="center">¥<%=show_book.rs.getString("proc_price") %>元</p>
                                </div>
                        	</div>         	
                        	<% }%>
                        	
                        	
                        	<%if(show_book.rs.next())  {%>
                        	<div style="margin-left:40px;">
                            	<div class="product_pic" align="center">
                                	<a target="_blank" href="book_product.jsp?id=<%=show_book.rs.getString("proc_id") %>"><img style="width:200px;height:200px" src="<%=show_book.rs.getString("proc_pic_url")%>" alt="Image"></a>
                                </div>
                                <div class="product_summ">
                                	<p align="center"><%=show_book.rs.getString("proc_jianjie")%></p>
                                </div>
                        	...
                        	<div style="margin-left:40px;">
                            	<div class="product_pic" align="center">
                                	<a target="_blank" href="book_product.jsp?id=<%=show_book.rs.getString("proc_id") %>"><img style="width:200px;height:200px" src="<%=show_book.rs.getString("proc_pic_url")%>"></a>
                                </div>
                                <div class="product_summ">
                                	<p align="center"><%=show_book.rs.getString("proc_jianjie")%></p>
                                </div>
			...
			<font color="#6666FF" size="+1"> 当前页数:【<%=showpage%>】&nbsp;&nbsp;&nbsp;
				...
				<a href="book.jsp?page=1">第一页</a>&nbsp;&nbsp; <a
				href="book.jsp?page=<%=showpage-16%>">上一页</a>&nbsp;&nbsp;

				<a href="book.jsp?page=<%=showpage+16%>">下一页</a>
				&nbsp;&nbsp; <a href="book.jsp?page=<%=pagecount%>">最后一页&nbsp;</a>&nbsp;&nbsp;
		</center>
