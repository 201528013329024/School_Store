...
<jsp:useBean id="show_others" class="com.sql.link_SqlServer" scope="session"></jsp:useBean>
	...
	<div id="body">
		<div>
                        ...
                        <%if(show_others.rs!= null) {%>
                        	<div style="margin-left:40px;">
                            	<div class="product_pic" align="center">
                                	<a target="_blank" href="others_product.jsp?id=<%=show_others.rs.getString("proc_id") %>"><img style="width:200px;height:200px" src="<%=show_others.rs.getString("proc_pic_url")%>" alt="Image"></a>
                                </div>
                                <div class="product_summ">
                                	<p align="center"><%=show_others.rs.getString("proc_jianjie")%></p>
                                </div>
                                <div class="product_price">
                                	<p align="center">¥<%=show_others.rs.getString("proc_price") %>元</p>
                                </div>
                        	</div>         	
                        	<% }%>
			...
			<font color="#6666FF" size="+1"> 当前页数:【<%=showpage%>】&nbsp;&nbsp;&nbsp;
				...
				<a href="others.jsp?page=1">第一页</a>&nbsp;&nbsp; <a
				href="others.jsp?page=<%=showpage-16%>">上一页</a>&nbsp;&nbsp;

				<a href="others.jsp?page=<%=showpage+16%>">下一页</a>
				&nbsp;&nbsp; <a href="others.jsp?page=<%=pagecount%>">最后一页&nbsp;</a>&nbsp;&nbsp;
		</center>
