				...
				<div>
					<div>
						...
						<ul>
							...
							<div style="margin-left: 204px; margin-top: -440px; height:100px;width: 400px">
							...
							<div
								...
								<table width="" border="0" align="left">
									<caption style="background-color: #96C">
										<font color="#FFFF00" size="+2">已卖出的宝贝信息</font>
									</caption>
								...
								<center>
									<font color="#6666FF" size="+1"> 当前页数:【<%=showpage%>】&nbsp;&nbsp;&nbsp;
										...
										<a href="have_sell.jsp?page=1">第一页</a>&nbsp;&nbsp; <a
										href="have_sell.jsp?page=<%=showpage - 1%>">上一页</a>&nbsp;&nbsp;

										<a href="have_sell.jsp?page=<%=showpage + 1%>">下一页</a>
										&nbsp;&nbsp; <a href="have_sell.jsp?page=<%=pagecount%>">最后一页&nbsp;</a>&nbsp;&nbsp;
