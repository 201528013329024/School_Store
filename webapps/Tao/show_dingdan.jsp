							...
							<div
								...
								<table width="" border="0" align="left">
									<caption style="background-color: #96C">
										<font color="#FFFF00" size="+2">查看我的订单</font>
									</caption>
									...
									<tr style="background-color: #CFF">
										...
										<td width="120" align="center">
									<a href="queren_deal.jsp?dingdan_id=<%=show_dingdan.rs.getString("dingdan_id")%>&proc_type=<%=show_dingdan.rs.getString("proc_type")%>&proc_id=<%=show_dingdan.rs.getString("proc_id")%>" style="text-decoration:none "><button  style="width:100px; height:22px; background-color:#6F9;" /><font color="#6666FF" size="2.5px"> 确认收货</font></a>
									</td>
