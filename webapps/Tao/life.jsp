...
<jsp:useBean id="show_life" class="com.sql.link_SqlServer" scope="session"></jsp:useBean>
	...
	<div id="body">
		<div>
				...
				<div>
					<div>
                   	 ...
                   	 //show_life.rs.next(); 
							...
							show_life.rs.absolute((showpage - 1) * 16 + 1);
							//show_life.rs.next();
                 	 ...
                 	 %>
                        ...
                        <%if(show_life.rs!= null) {%>
                        	<div style="margin-left:40px;">
                            	<div class="product_pic" align="center">
                                	<a target="_blank" href="life_product.jsp?id=<%=show_life.rs.getString("proc_id") %>"><img src="<%=show_life.rs.getString("proc_pic_url")%>" style="width:200px;height:200px"></a>       
                                </div>
                                <div class="product_summ">
                                	<p align="center"><%=show_life.rs.getString("proc_jianjie")%></p>
                                </div>
                                <div class="product_price">
                                	<p align="center">¥<%=show_life.rs.getString("proc_price") %>元</p>
                                </div>
                        	</div>         	
                        	<% }%>
                        	
                        	
                        	<%if(show_life.rs.next())  {%>
                        	<div style="margin-left:40px;">
                            	<div class="product_pic" align="center">
                                	<a target="_blank" href="life_product.jsp?id=<%=show_life.rs.getString("proc_id") %>"><img style="width:200px;height:200px" src="<%=show_life.rs.getString("proc_pic_url")%>" alt="Image"></a>
                                </div>
                                <div class="product_summ">
                                	<p align="center"><%=show_life.rs.getString("proc_jianjie")%></p>
                                </div>
			...
			<font color="#6666FF" size="+1"> 当前页数:【<%=showpage%>】&nbsp;&nbsp;&nbsp;
				...
				<a href="life.jsp?page=1">第一页</a>&nbsp;&nbsp; <a
				href="life.jsp?page=<%=showpage- 16%>">上一页</a>&nbsp;&nbsp;

				<a href="life.jsp?page=<%=showpage + 16%>">下一页</a>
				&nbsp;&nbsp; <a href="life.jsp?page=<%=pagecount%>">最后一页&nbsp;</a>&nbsp;&nbsp;
