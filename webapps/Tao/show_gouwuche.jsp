...
<jsp:useBean id="show_gwc" class="com.sql.link_SqlServer"
							...
							<div
								...
								<table width="" border="0" align="left">
									<caption style="background-color: #96C">
										<font color="#FFFF00" size="+2">查看我的购物车</font>
									</caption>
									...
									<tr style="background-color: #CFF">
										...
										<a href=<%=url%>>	<%=show_gwc.show_gouwuche_content_rs.getString("proc_name")%>
										</a></td>

										<td width="" align="center">
											<%=show_gwc.show_gouwuche_content_rs.getString("proc_price")%>
										</td>



										<td width="" align="center">
											<%=show_gwc.show_gouwuche_content_rs.getString("proc_jianjie")%>
										</td>
								...
								<center>
									<font color="#6666FF" size="+1"> 当前页数:【<%=showpage%>】&nbsp;&nbsp;&nbsp;
										...
										<a href="show_gouwuche.jsp?page=1">第一页</a>&nbsp;&nbsp; <a
										href="show_gouwuche.jsp?page=<%=showpage - 1%>">上一页</a>&nbsp;&nbsp;

										<a href="show_gouwuche.jsp?page=<%=showpage + 1%>">下一页</a>
										&nbsp;&nbsp; <a href="show_gouwuche.jsp?page=<%=pagecount%>">最后一页&nbsp;</a>&nbsp;&nbsp;
