...
<jsp:useBean id="show_electronic" class="com.sql.link_SqlServer" scope="session"></jsp:useBean>
	...
	<div id="body">
		<div>
                        ...
                        <%if(show_electronic.rs!= null) {%>
                        	<div style="margin-left:40px;">
                            	...
                            	<div class="product_pic" align="center">
                                	<a target="_blank" href="electronic_product.jsp?id=<%=show_electronic.rs.getString("proc_id") %>"><img src="<%=show_electronic.rs.getString("proc_pic_url")%>" style="width:200px;height:200px"></a>
                                </div>
                                <div class="product_summ">
                                	<p align="center"><%=show_electronic.rs.getString("proc_jianjie")%></p>
                                </div>
                                <div class="product_price">
                                	<p align="center">¥<%=show_electronic.rs.getString("proc_price") %>元</p>
                                </div>
                        	</div>         	
                        	<% }%>
			...
			<font color="#6666FF" size="+1"> 当前页数:【<%=showpage%>】&nbsp;&nbsp;&nbsp;
				...
				<a href="electronic.jsp?page=1">第一页</a>&nbsp;&nbsp; <a
				href="electronic.jsp?page=<%=showpage- 16%>">上一页</a>&nbsp;&nbsp;

				<a href="electronic.jsp?page=<%=showpage + 16%>">下一页</a>
				&nbsp;&nbsp; <a href="electronic.jsp?page=<%=pagecount%>">最后一页&nbsp;</a>&nbsp;&nbsp;
