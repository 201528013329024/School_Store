...
public final class show_005fdingdan_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\t\t\t\t\t\t\t");
									...
									show_dingdan.dingdan_show(user);
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<font color=\"#FFFF00\" size=\"+2\">查看我的订单</font>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</caption>\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"\" id=\"x2\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<a href=");
      out.print(url);
      out.write('>');
      out.write('	');
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"120\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"queren_deal.jsp?dingdan_id=");
      out.print(show_dingdan.rs.getString("dingdan_id"));
      out.write("&proc_type=");
      out.print(show_dingdan.rs.getString("proc_type"));
      out.write("&proc_id=");
      out.print(show_dingdan.rs.getString("proc_id"));
      out.write("\" style=\"text-decoration:none \"><button  style=\"width:100px; height:22px; background-color:#6F9;\" /><font color=\"#6666FF\" size=\"2.5px\"> 确认收货</font></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"120\" align=\"center\">\r\n");
