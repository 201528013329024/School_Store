...
public final class show_005fliuyan_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\r\n");
      out.write("\r\n");
      com.sql.link_SqlServer show_liuyan = null;
      synchronized (session) {
        show_liuyan = (com.sql.link_SqlServer) _jspx_page_context.getAttribute("show_liuyan", PageContext.SESSION_SCOPE);
        if (show_liuyan == null){
          show_liuyan = new com.sql.link_SqlServer();
          _jspx_page_context.setAttribute("show_liuyan", show_liuyan, PageContext.SESSION_SCOPE);
        }
      }
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t");
									...
									show_liuyan.liuyan_show(user);

									//show_liuyan.rs.next();
									show_liuyan.rs.last();
									rowcount = show_liuyan.rs.getRow();
									...
									show_liuyan.rs.absolute((showpage - 1) * pagesize + 1);
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"175\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t留言时间\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print(show_liuyan.rs.getString("liuyan_id"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(show_liuyan.rs.getString("liuyan_person"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"\" align=\"center\">");
      out.print(show_liuyan.rs.getString("give_price"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(show_liuyan.rs.getString("liuyan_tel"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<a\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\thref=\"show_liuyan_content.jsp?liuyan_id=");
      out.print(show_liuyan.rs.getString("liuyan_id"));
      out.write("&proc_id=");
      out.print(show_liuyan.rs.getString("proc_id"));
      out.write("&proc_type=");
      out.print(show_liuyan.rs.getString("proc_type"));
      out.write("\">回复留言</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(show_liuyan.rs.getString("liuyan_time"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"\" align=\"center\">\r\n");
      ...
      out.write("】&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"show_liuyan.jsp?page=1\">第一页</a>&nbsp;&nbsp; <a\r\n");
      out.write("\t\t\t\t\t\t\t\t\thref=\"show_liuyan.jsp?page=");
      out.print(showpage - 1);
      out.write("\">上一页</a>&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"show_liuyan.jsp?page=");
      out.print(showpage + 1);
      out.write("\">下一页</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t&nbsp;&nbsp; <a href=\"show_liuyan.jsp?page=");
      out.print(pagecount);
