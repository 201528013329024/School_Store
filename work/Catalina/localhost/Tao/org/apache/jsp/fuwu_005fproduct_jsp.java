...
public final class fuwu_005fproduct_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write('\r');
      out.write('\n');
      com.sql.link_SqlServer fuwu_xiangxi = null;
      synchronized (session) {
        fuwu_xiangxi = (com.sql.link_SqlServer) _jspx_page_context.getAttribute("fuwu_xiangxi", PageContext.SESSION_SCOPE);
        if (fuwu_xiangxi == null){
          fuwu_xiangxi = new com.sql.link_SqlServer();
          _jspx_page_context.setAttribute("fuwu_xiangxi", fuwu_xiangxi, PageContext.SESSION_SCOPE);
        }
      }
      out.write("\r\n");
	...
	out.print("今天是"+year+"年"+month+"月"+day +"日"+" "+week+" ");
      ...
      out.write("\t\t\t\t\t\t<img src=\"");
      out.print(fuwu_xiangxi.check_fuwu_rs.getString("proc_pic_url"));
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>");
      out.print(fuwu_xiangxi.check_fuwu_rs.getString("proc_name"));
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t￥");
      out.print(fuwu_xiangxi.check_fuwu_rs.getString("proc_price"));
      out.write("元\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"add\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>");
      out.print(fuwu_xiangxi.check_fuwu_rs.getString("proc_xiangjie"));
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"add\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>");
      out.print(fuwu_xiangxi.check_fuwu_rs.getString("seller_name"));
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"add\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>");
      out.print(fuwu_xiangxi.check_fuwu_rs.getString("seller_tel"));
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"add\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>");
      out.print(fuwu_xiangxi.check_fuwu_rs.getString("seller_addr"));
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<br />\r\n");
      ...
      out.write("&proc_type=");
      out.print(fuwu_xiangxi.check_fuwu_rs.getString("proc_type"));
      out.write("\">  \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t    <a href=\"fuwu_product_goumai.jsp?id=");
      out.print(id);
      out.write("\">\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t  <img src=\"images/insert_gwc.jpg\" style=\"width:80px;height:80px\"></img></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<br/><br/>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
								...
								int temp = Integer.parseInt(fuwu_xiangxi.check_fuwu_rs.getString("zan_count"));
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<");
      out.print(fuwu_xiangxi.check_fuwu_rs.getString("zan_count"));
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
