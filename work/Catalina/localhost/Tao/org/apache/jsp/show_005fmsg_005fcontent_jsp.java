...
public final class show_005fmsg_005fcontent_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\r\n");
      out.write("\r\n");
      com.sql.link_SqlServer show_msg_content = null;
      synchronized (session) {
        show_msg_content = (com.sql.link_SqlServer) _jspx_page_context.getAttribute("show_msg_content", PageContext.SESSION_SCOPE);
        if (show_msg_content == null){
          show_msg_content = new com.sql.link_SqlServer();
          _jspx_page_context.setAttribute("show_msg_content", show_msg_content, PageContext.SESSION_SCOPE);
        }
      }
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t");
			...
			show_msg_content.link();
			String msg_id = request.getParameter("msg_id");
			String proc_id = request.getParameter("proc_id");
			String proc_type = request.getParameter("proc_type");
			show_msg_content.msg_show_content(msg_id);
			show_msg_content.rs.next();
			show_msg_content.check_proc(proc_type,proc_id);
      ...
      out.write("\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<h2><a href=\"show_msg.jsp\">我的留言</a></h2>\r\n");
      out.write("\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t<li>\r\n");
      ...
      out.write("\t\t\t\taction=\"show_msg_content_deal.jsp?from_msg_id=");
      out.print(show_msg_content.rs.getString("huifu_liuyan_id"));
      out.write("&proc_type=");
      out.print(show_msg_content.rs.getString("proc_type"));
      out.write("&to_who=");
      out.print(show_msg_content.rs.getString("liuyan_person"));
      out.write("&msg_person=");
      out.print(show_msg_content.rs.getString("to_who"));
      out.write("\"\r\n");
      ...
      out.print(show_msg_content.rs.getString("content"));
      out.write("</textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t");
									  ...
									  String url = show_msg_content.check_proc_rs.getString("proc_type")+"_product.jsp?id="+show_msg_content.check_proc_rs.getString("proc_id");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t商品名称：");
      out.print(show_msg_content.check_proc_rs.getString("proc_name"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价：");
      out.print(show_msg_content.check_proc_rs.getString("proc_price"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
