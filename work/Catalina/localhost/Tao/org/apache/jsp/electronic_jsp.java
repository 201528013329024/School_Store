...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("</head>\r\n");
      com.sql.link_SqlServer show_electronic = null;
      synchronized (session) {
        show_electronic = (com.sql.link_SqlServer) _jspx_page_context.getAttribute("show_electronic", PageContext.SESSION_SCOPE);
        if (show_electronic == null){
          show_electronic = new com.sql.link_SqlServer();
          _jspx_page_context.setAttribute("show_electronic", show_electronic, PageContext.SESSION_SCOPE);
        }
      }
      out.write("\r\n");
      out.write("\r\n");
	...
	out.print("今天是"+year+"年"+month+"月"+day +"日"+" "+week+" ");
      ...
      out.write("                        ");
                   	        ...
                   	        //show_electronic.rs.next(); 
                        	show_electronic.rs.last();
							rowcount = show_electronic.rs.getRow();
							...
							show_electronic.rs.absolute((showpage - 1) * 16 + 1);
							//show_electronic.rs.next();
      ...
      out.write("                            \r\n");
      out.write("                        ");
if(show_electronic.rs!= null) {
      out.write("\r\n");
      out.write("                        \t<div style=\"margin-left:40px;\">\r\n");
      out.write("                        \t    ");
   System.out.println(show_electronic.rs.getString("proc_pic_url"));
      out.write("\r\n");
      out.write("                            \t<div class=\"product_pic\" align=\"center\">\r\n");
      out.write("                                \t<a target=\"_blank\" href=\"electronic_product.jsp?id=");
      out.print(show_electronic.rs.getString("proc_id") );
      out.write("\"><img src=\"");
      out.print(show_electronic.rs.getString("proc_pic_url"));
      out.write("\" style=\"width:200px;height:200px\"></a>\r\n");
      out.write("                                </div>\r\n");
      out.write("                                <div class=\"product_summ\">\r\n");
      out.write("                                \t<p align=\"center\">");
      out.print(show_electronic.rs.getString("proc_jianjie"));
      out.write("</p>\r\n");
      out.write("                                </div>\r\n");
      out.write("                                <div class=\"product_price\">\r\n");
      out.write("                                \t<p align=\"center\">¥");
      out.print(show_electronic.rs.getString("proc_price") );
      out.write("元</p>\r\n");
      out.write("                                </div>\r\n");
      out.write("                        \t</div>         \t\r\n");
      out.write("                        \t");
...
if(show_electronic.rs.next())  {
      ...
      out.write("】&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<a href=\"electronic.jsp?page=1\">第一页</a>&nbsp;&nbsp; <a\r\n");
      out.write("\t\t\t\thref=\"electronic.jsp?page=");
      out.print(showpage- 16);
      out.write("\">上一页</a>&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<a href=\"electronic.jsp?page=");
      out.print(showpage + 16);
      out.write("\">下一页</a>\r\n");
      out.write("\t\t\t\t&nbsp;&nbsp; <a href=\"electronic.jsp?page=");
      out.print(pagecount);
