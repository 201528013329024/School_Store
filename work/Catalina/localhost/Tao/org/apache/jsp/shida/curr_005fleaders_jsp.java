...
public final class curr_005fleaders_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	out.print("今天是"+year+"年"+month+"月"+day +"日"+" "+week+" ");
      ...
      out.write("\t\t\t\t\t\t\t<tr> \r\n");
      out.write("\t\t\t\t\t\t\t<td align=\"middle\" width=\"80PX\" height=\"38\">党委书记</td> \r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"80PX\" height=\"38\">　顾家山</td> \r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"600PX\" height=\"38\">主持学校党委全面工作。分管组织建设与干部工作、保密、国家安全、维护稳定等工作；代管宣传、统战、机关、精神文明建设、学生思想政治教育与管理、人民武装、共青团、网络、信息、安全保卫、综合治理等工作。分管办公室、组织部（党校）；代管宣传部（新闻中心）、统战部（港澳台侨事务办公室）、机关党委（机关工作处）、学生工作处（学工部、人武部）、保卫处、团委、信息管理中心、教育部高校辅导员培训和研修基地管委会办公室（《高校辅导员学刊》编辑部）。联系政治学院、法学院、经济管理学院、音乐学院、教育科学学院、数学计算机科学学院。</td> \r\n");
      out.write("\t\t\t\t\t\t\t</tr> \r\n");
      out.write("\t\t\t\t\t\t\t<tr> \r\n");
      out.write("\t\t\t\t\t\t\t<td align=\"middle\" width=\"\" height=\"38\">校长<br /> \r\n");
      out.write("\t\t\t\t\t\t\t党委副书记</td> \r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"\" height=\"38\">　王　伦</td> \r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"\" height=\"38\">主持学校行政全面工作。分管发展规划、人事、财务、董事会、校友会、基金会、独立学院办学等工作；代管后勤、爱国卫生工作。分管发展规划处、人事处、财务处、董事会、校友会、基金会、皖江学院；代管后勤管理处、后勤集团、爱卫会。联系文学院、传媒学院。</td> \r\n");
      out.write("\t\t\t\t\t\t\t</tr> \r\n");
      out.write("\t\t\t\t\t\t\t<tr> \r\n");
      out.write("\t\t\t\t\t\t\t<td align=\"middle\" width=\"\" height=\"38\">纪委书记</td> \r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"\" height=\"38\">　程　度</td> \r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"\" height=\"38\">主管纪委工作。分管审计、医疗卫生、计划生育等工作；代管离退休、工会、教代会、关心下一代工作。分管监察处、审计处、校医院、计生委；代管离退休工作处、工会、关工委。联系美术学院、化学与材料科学学院。</td> \r\n");
      out.write("\t\t\t\t\t\t\t</tr> \r\n");
      out.write("\t\t\t\t\t\t\t<tr> \r\n");
      out.write("\t\t\t\t\t\t\t<td align=\"middle\" width=\"\" height=\"38\">副校长</td> \r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"\" height=\"38\">　王绍武</td> \r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"\" height=\"38\">分管科研、社会服务、学科建设、资产管理、产业、出版、学报等工作；代管外事、留学生教育与管理工作。分管科研处、资产管理处、出版社、学报编辑部；代管国际教育学院（外事办公室）。联系外国语学院、物理与电子信息学院、环境科学与工程学院。</td> \r\n");
      out.write("\t\t\t\t\t\t\t</tr> \r\n");
      out.write("\t\t\t\t\t\t\t<tr> \r\n");
      out.write("\t\t\t\t\t\t\t<td align=\"middle\" width=\"\" height=\"38\">副校长</td> \r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"\" height=\"38\">　李琳琦</td> \r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"\" height=\"38\">分管学位与研究生教育、图书资料、档案管理、附属学校等工作。分管研究生学院（研究生工作部）、图书馆、档案馆、教育集团、附中、附小、附幼。联系历史与社会学院、国土资源与旅游学院。</td> \r\n");
      out.write("\t\t\t\t\t\t\t</tr> \r\n");
      out.write("\t\t\t\t\t\t\t<tr> \r\n");
      out.write("\t\t\t\t\t\t\t<td align=\"middle\" width=\"\" height=\"38\">副校长</td> \r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"\" height=\"38\">　李进华</td> \r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"\" height=\"38\">分管本科教学、招生、教学评估、思想政治理论课建设、体育、高校师资培训等工作；代管继续教育、花津校区建设、教职工住宅建设工作。分管教务处（招生办）、教学评估办公室、思想政治理论课教研部、体委、省高等学校师资培训中心；代管继续教育学院、科创房地产开发有限公司（新校区建设指挥部综合办）。联系生命科学学院、体育学院。</td> \r\n");
      out.write("\t\t\t\t\t\t\t</tr> \r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<tr> \r\n");
      out.write("\t\t\t\t\t\t\t<td align=\"middle\" width=\"\" height=\"38\">校长助理</td> \r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"\" height=\"38\">　沈　洪</td> \r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"\" height=\"38\">协助校长管理董事会、校友会、基金会、独立学院办学等工作。协调校长交办的其他工作。</td> \r\n");
      out.write("\t\t\t\t\t\t\t</tr> \r\n");
      out.write("\t\t\t\t\t\t\t</table> \r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
