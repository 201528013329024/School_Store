...
public final class others_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("</head>\r\n");
      com.sql.link_SqlServer show_others = null;
      synchronized (session) {
        show_others = (com.sql.link_SqlServer) _jspx_page_context.getAttribute("show_others", PageContext.SESSION_SCOPE);
        if (show_others == null){
          show_others = new com.sql.link_SqlServer();
          _jspx_page_context.setAttribute("show_others", show_others, PageContext.SESSION_SCOPE);
        }
      }
      out.write("\r\n");
      out.write("\r\n");
	...
	out.print("今天是"+year+"年"+month+"月"+day +"日"+" "+week+" ");
      ...
      out.write("                        ");
                   	 ...
                   	 //show_others.rs.next(); 
                        	show_others.rs.last();
							rowcount = show_others.rs.getRow();//20
							...
							show_others.rs.absolute((showpage - 1) *16 + 1);
							//show_others.rs.next();
      ...
      out.write("                            \r\n");
      out.write("                        ");
if(show_others.rs!= null) {
      out.write("\r\n");
      out.write("                        \t<div style=\"margin-left:40px;\">\r\n");
      out.write("                            \t<div class=\"product_pic\" align=\"center\">\r\n");
      out.write("                                \t<a target=\"_blank\" href=\"others_product.jsp?id=");
      out.print(show_others.rs.getString("proc_id") );
      out.write("\"><img style=\"width:200px;height:200px\" src=\"");
      out.print(show_others.rs.getString("proc_pic_url"));
      out.write("\" alt=\"Image\"></a>\r\n");
      out.write("                                </div>\r\n");
      out.write("                                <div class=\"product_summ\">\r\n");
      out.write("                                \t<p align=\"center\">");
      out.print(show_others.rs.getString("proc_jianjie"));
      out.write("</p>\r\n");
      out.write("                                </div>\r\n");
      out.write("                                <div class=\"product_price\">\r\n");
      out.write("                                \t<p align=\"center\">¥");
      out.print(show_others.rs.getString("proc_price") );
      out.write("元</p>\r\n");
      out.write("                                </div>\r\n");
      out.write("                        \t</div>         \t\r\n");
      out.write("                        \t");
...
if(show_others.rs.next())  {
      ...
      out.write("】&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<a href=\"others.jsp?page=1\">第一页</a>&nbsp;&nbsp; <a\r\n");
      out.write("\t\t\t\thref=\"others.jsp?page=");
      out.print(showpage-16);
      out.write("\">上一页</a>&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<a href=\"others.jsp?page=");
      out.print(showpage+16);
      out.write("\">下一页</a>\r\n");
      out.write("\t\t\t\t&nbsp;&nbsp; <a href=\"others.jsp?page=");
      out.print(pagecount);
