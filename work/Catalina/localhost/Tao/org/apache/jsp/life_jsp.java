...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("</head>\r\n");
      com.sql.link_SqlServer show_life = null;
      synchronized (session) {
        show_life = (com.sql.link_SqlServer) _jspx_page_context.getAttribute("show_life", PageContext.SESSION_SCOPE);
        if (show_life == null){
          show_life = new com.sql.link_SqlServer();
          _jspx_page_context.setAttribute("show_life", show_life, PageContext.SESSION_SCOPE);
        }
      }
      out.write("\r\n");
      out.write("\r\n");
...
if(show_life.rs!= null) {
      ...
      out.write("                                \t<a target=\"_blank\" href=\"life_product.jsp?id=");
      out.print(show_life.rs.getString("proc_id") );
      out.write("\"><img src=\"");
      out.print(show_life.rs.getString("proc_pic_url"));
      out.write("\" style=\"width:200px;height:200px\"></a>       \r\n");
      out.write("                                </div>\r\n");
      out.write("                                <div class=\"product_summ\">\r\n");
      out.write("                                \t<p align=\"center\">");
      out.print(show_life.rs.getString("proc_jianjie"));
      out.write("</p>\r\n");
      out.write("                                </div>\r\n");
      out.write("                                <div class=\"product_price\">\r\n");
      out.write("                                \t<p align=\"center\">¥");
      out.print(show_life.rs.getString("proc_price") );
      out.write("元</p>\r\n");
      out.write("                                </div>\r\n");
      out.write("                        \t</div>         \t\r\n");
      out.write("                        \t");
...
if(show_life.rs.next())  {
      ...
      out.write("】&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<a href=\"life.jsp?page=1\">第一页</a>&nbsp;&nbsp; <a\r\n");
      out.write("\t\t\t\thref=\"life.jsp?page=");
      out.print(showpage- 16);
      out.write("\">上一页</a>&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<a href=\"life.jsp?page=");
      out.print(showpage + 16);
      out.write("\">下一页</a>\r\n");
      out.write("\t\t\t\t&nbsp;&nbsp; <a href=\"life.jsp?page=");
      out.print(pagecount);
