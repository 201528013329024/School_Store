...
public final class show_005fmsg_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\r\n");
      out.write("\r\n");
      com.sql.link_SqlServer show_msg = null;
      synchronized (session) {
        show_msg = (com.sql.link_SqlServer) _jspx_page_context.getAttribute("show_msg", PageContext.SESSION_SCOPE);
        if (show_msg == null){
          show_msg = new com.sql.link_SqlServer();
          _jspx_page_context.setAttribute("show_msg", show_msg, PageContext.SESSION_SCOPE);
        }
      }
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<font color=\"#FFFF00\" size=\"+2\">查看我的留言回复</font>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</caption>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr style=\"background-color: #3CF\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"395\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t留言来源\r\n");
      out.write("\t\t\t\t\t\t\t\t    </td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"295\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t回复伙伴\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t我的【");
      out.print(show_msg.rs.getString("from_liuyan_id"));
      out.write("】号留言\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print(show_msg.rs.getString("liuyan_person"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t    </td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<a href=\"show_msg_content.jsp?msg_id=");
      out.print(show_msg.rs.getString("huifu_liuyan_id"));
      out.write("&proc_id=");
      out.print(show_msg.rs.getString("proc_id"));
      out.write("&proc_type=");
      out.print(show_msg.rs.getString("proc_type"));
      out.write("\">回复留言</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(show_msg.rs.getString("huifu_liuyan_time"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"\" align=\"center\">\r\n");
      ...
      out.write("】&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"show_msg.jsp?page=1\">第一页</a>&nbsp;&nbsp; <a\r\n");
      out.write("\t\t\t\t\t\t\t\t\thref=\"show_msg.jsp?page=");
      out.print(showpage - 1);
      out.write("\">上一页</a>&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"show_msg.jsp?page=");
      out.print(showpage + 1);
      out.write("\">下一页</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t&nbsp;&nbsp; <a href=\"show_msg.jsp?page=");
      out.print(pagecount);
