...
public final class drop_005fproc_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\r\n");
      out.write("\r\n");
      com.sql.link_SqlServer drop_proc = null;
      synchronized (session) {
        drop_proc = (com.sql.link_SqlServer) _jspx_page_context.getAttribute("drop_proc", PageContext.SESSION_SCOPE);
        if (drop_proc == null){
          drop_proc = new com.sql.link_SqlServer();
          _jspx_page_context.setAttribute("drop_proc", drop_proc, PageContext.SESSION_SCOPE);
        }
      }
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<div style=\"margin-left: 200px; margin-top: -415px; width: 740px;height: 440px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<table width=\"750px\" border=\"0\" align=\"left\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<caption style=\"background-color: #96C\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<font color=\"#FFFF00\" size=\"+2\">查看我的所有上架商品</font>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</caption>\r\n");
      ...
      out.print(url);
      out.write("><img src=\"");
      out.print(drop_proc.show_gouwuche_content_rs.getString("proc_pic_url"));
      out.write("\" style=\"width:60px;height:50px\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(drop_proc.show_gouwuche_content_rs.getString("proc_name"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(drop_proc.show_gouwuche_content_rs.getString("proc_price"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(drop_proc.show_gouwuche_content_rs.getString("add_time"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(drop_proc.show_gouwuche_content_rs.getString("zan_count"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<a href=\"drop_proc_deal.jsp?proc_type=");
      out.print(drop_proc.rs.getString("proc_type"));
      out.write("&proc_id=");
      out.print(drop_proc.rs.getString("proc_id"));
      out.write("\">下架</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t        <tr height=\"10\"><td colspan=\"9\"></td></tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<center>\r\n");
      ...
      out.write("】&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"drop_proc.jsp?page=1\">第一页</a>&nbsp;&nbsp; <a\r\n");
      out.write("\t\t\t\t\t\t\t\t\thref=\"drop_proc.jsp?page=");
      out.print(showpage - 1);
      out.write("\">上一页</a>&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"drop_proc.jsp?page=");
      out.print(showpage + 1);
      out.write("\">下一页</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t&nbsp;&nbsp; <a href=\"drop_proc.jsp?page=");
      out.print(pagecount);
      ...
      out.write("  <div style=\"margin-left: 204px; margin-top: -440px; height:10px;width: 400px\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t您目前还没有上架的商品  \r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t}");
}
