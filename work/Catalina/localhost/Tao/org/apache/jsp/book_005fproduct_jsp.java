...
public final class book_005fproduct_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	out.print("今天是"+year+"年"+month+"月"+day +"日"+" "+week+" ");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<img src=\"");
      out.print(book_xiangxi.check_book_rs.getString("proc_pic_url"));
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>");
      out.print(book_xiangxi.check_book_rs.getString("proc_name"));
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t￥");
      out.print(book_xiangxi.check_book_rs.getString("proc_price"));
      out.write("元\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"add\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>");
      out.print(book_xiangxi.check_book_rs.getString("proc_xiangjie"));
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"add\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>");
      out.print(book_xiangxi.check_book_rs.getString("seller_name"));
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"add\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>");
      out.print(book_xiangxi.check_book_rs.getString("seller_tel"));
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"add\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>");
      out.print(book_xiangxi.check_book_rs.getString("seller_addr"));
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<br />\r\n");
      ...
      out.write("&proc_type=");
      out.print(book_xiangxi.check_book_rs.getString("proc_type"));
      out.write("\">  \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t    <a href=\"book_product_goumai.jsp?id=");
      out.print(id);
      out.write("\">\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t  <img src=\"images/insert_gwc.png\" style=\"width:80px;height:80px\"></img></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<br/><br/>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<");
      out.print(book_xiangxi.check_book_rs.getString("zan_count"));
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
